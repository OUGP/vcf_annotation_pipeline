rule gatk4_FilterVariantTranches:
    ...
    shell:
        "( /usr/bin/time gatk FilterVariantTranches -V {input.vcf} -O {output} --tmp-dir {params.tdir} {params.padding} {params.intervals} {params.resources} {params.other} ) 2> times/gatk_filter_variant_tranches.stderr"